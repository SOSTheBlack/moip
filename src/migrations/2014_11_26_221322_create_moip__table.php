...
class CreateMoipTable extends Migration {
	...
	public function up()
	{
		Schema::create('moip', function($table){
			...
			$table->boolean('payment_billet')->comment('Para disponibilizar a opção "Boleto Bancário" como forma de pagamento no checkout Moip');
			$table->boolean('payment_financing')->comment('Para disponibilizar a opção "Financiamento" como forma de pagamento no checkout Moip');
			$table->boolean('payment_debit')->comment('Para disponibilizar a opção "Debito em conta" como forma de pagamento no checkout Moip');
			$table->boolean('payment_credit_card')->comment('Para disponibilizar a opção "Cartão de Crédito" como forma de pagamento no checkout Moip');
			$table->boolean('payment_debit_card')->comment('Para disponibilizar a opção "Cartão de débito" como forma de pagamento no checkout Moip');
		});
	}
